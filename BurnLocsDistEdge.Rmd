...
# Convert burn_compartments_2022 polygons to line geometries to represent their boundaries.
burn_compartment_boundaries <- st_boundary(burn_compartments_2022)


# Creating tibble of points to sf object
...
# Applying the function min() to each row (1 does this) in the distance matrix
